...
- (void) captureImageForDeviceOrientation:(UIDeviceOrientation)deviceOrientation
{
    ...
    [_stillImageOutput captureStillImageAsynchronouslyFromConnection:videoConnection
         ...
         if ( imageDataSampleBuffer != NULL ) {
           ...
           // UIImage *image = [[[UIImage alloc] initWithData:imageData] imageInRect:CGRectMake(0, 855, 2448, 1554)];
             UIImage *image = [[[UIImage alloc] initWithData:imageData] croppedImage:CGRectMake(855, 0, 1554, 2448)];
